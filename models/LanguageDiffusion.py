...
"""
LanguageDiffusion
	A decoder-only multiheaded BERT transformer with
	MLP vocabulary classifier.
"""
class LanguageDiffusion(nn.Module):

	"""
	LanguageDiffusion.__init__
	...
	def forward(self, seq):
		...
		seq_out = self.transformer(src=seq_embed)
