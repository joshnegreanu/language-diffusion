...
class AutoregressiveVocabulary:
    ...
    """
    AutoregressiveVocabulary.__len__
    ...
    """
    AutoregressiveVocabulary.text2idx
    ...
    """
    AutoregressiveVocabulary.idx2text
    ...
    """
    AutoregressiveVocabulary.build_vocab
...
class AutoregressiveLanguageDataset(Dataset):
    def __init__(self, max_examples, max_len, bs):
        ...
        self.vocab = AutoregressiveVocabulary(self.data, self.tokenizer)
    ...
    """
    AutoregressiveLanguageDataset.__len__
    ...
    """
    AutoregressiveLanguageDataset.__getitem__
    ...
    """
    AutoregressiveLanguageDataset.pad_collate
    ...
    """
    AutoregressiveLanguageDataset.create_dataloader
